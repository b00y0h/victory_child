...
/*----------------------------------------------------------------------------------*/
	...
	var ads_page_meta = jQuery('#ads_page_meta');
	ads_page_meta.css('display', 'none');
...
/*----------------------------------------------------------------------------------*/
	...
	group.change( function() {
		...
		} else if(jQuery(this).val() == 'page-ads.php')  {
			ads_page_meta.css('display', 'block');
			tzHideAll(ads_page_meta);
			pages_widget_area.css('display', 'block');
			SidebarHideAll(pages_widget_area);
...
/*----------------------------------------------------------------------------------*/	
	...
	if (jQuery("#page_template option[value='page-ads.php']").attr('selected'))
		{ 
			ads_page_meta.css('display', 'block');
			pages_widget_area.css('display', 'block');
			posts_widget_area.css('display', 'none');
