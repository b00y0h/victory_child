		...
		$shortcodes = array(
			...
			'contact_form' => array(
				...
				'atts' => array(
					'email_address' => array(
						'values' => array( ),
						'default' => __( '', 'shortcodes-ultimate' ),
						'desc' => __( 'Insert your email here', 'shortcodes-ultimate' )
					)
				),
				'usage' => '[contact_form email="Insert your email here"]',
				'content' => __( 'Contact form', 'shortcodes-ultimate' ),
				'desc' => __( 'Contact form', 'shortcodes-ultimate' )
			),
			# headline
			'headline' => array(
				'name' => 'Headline',
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Headline title', 'shortcodes-ultimate' )
					),
					'link' => array(
						'values' => array( ),
						'default' => __( '#', 'shortcodes-ultimate' ),
						'desc' => __( 'Headline link', 'shortcodes-ultimate' )
					),
					'border_bottom' => array(
						'values' => array( ),
						'default' => __( 'yes', 'shortcodes-ultimate' ),
						'desc' => __( 'Display bottom border', 'shortcodes-ultimate' )
					),
					'border_top' => array(
						'values' => array( ),
						'default' => __( 'yes', 'shortcodes-ultimate' ),
						'desc' => __( 'Display top border', 'shortcodes-ultimate' )
					)
				),
				'usage' => '[headline title="Title goes here" link="http://www.google.com" border_top="yes" border_bottom="yes"] Content [/heading]',
				'content' => __( 'Headline', 'shortcodes-ultimate' ),
				'desc' => __( 'Styled headline', 'shortcodes-ultimate' )
			),
			# heading
			'heading' => array(
				'name' => 'Heading',
...
//			),
			...
			'media' => array(
				...
				'usage' => '[media url="http://www.youtube.com/watch?v=2c2EEacfC1M"]<br/>[media url="http://vimeo.com/15069551"]<br/>[media url="video.mp4"]<br/>[media url="video.flv"]<br/>[media url="audio.mp3"]<br/>[media url="video.flv" jwplayer="controlbar=bottom&autostart=true"]',
				'desc' => __( 'YouTube video, Vimeo video, .mp4/.flv video, .mp3 file', 'shortcodes-ultimate' )
			),
			# document
			'document' => array(
				'name' => 'Document',
			...
			'flexslider' => array(
				...
				'usage' => '[flexslider]<br/>[flexslider source="post" link="image" size="500x300" limit="10" effect="boxRandom"]<br/>[flexslider source="cat=1" link="permalink" size="500x300" limit="10" effect="boxRandom"]',
				'desc' => __( 'Flexslider attached to post images', 'shortcodes-ultimate' )
			),
			# flexcarousel
			'flexcarousel' => array(
				'name' => 'flexcarousel',
				...
				'usage' => '[flexcarousel]<br/>[flexcarousel source="post" link="image" size="150x150" limit="10" items="3"]<br/>[flexcarousel source="cat=1" link="permalink" size="150x150" limit="10" items="3"]',
				'desc' => __( 'flexcarousel by attached to post images', 'shortcodes-ultimate' )
			),
			# custom_gallery
			...
			'recent_posts' => array(
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Most recent posts from your blog', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
						'desc' => __( 'Number of posts to show', 'shortcodes-ultimate' )
					),
					'cats' => array(
						'values' => false,
						'default' => '',
						'desc' => __( 'Insert the categories from where the post should appear, separated by commas(",")', 'shortcodes-ultimate' )
					),
					'wordscount' => array(
						'values' => false,
						'default' => '20',
						'desc' => __( 'Limit de post description. Put "0" to disable.', 'shortcodes-ultimate' )
					)
				),
				'usage' => '[recent_posts title="Recent posts" limit="5" cats="" wordscount="20"]',
				'desc' => __( 'Recent posts', 'shortcodes-ultimate' )
			),
			# Blog popular posts
			'popular_posts' => array(
				'name' => 'Popular posts',
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Most popular posts from your blog', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[popular_posts title="Popular posts" limit="5" cats="" wordscount="20"]',
				'desc' => __( 'Popular posts', 'shortcodes-ultimate' )
			),
			# Portfolio Recent Posts
			'portfolio_recent_posts' => array(
				'name' => 'Portfolio Recent Posts',
				'type' => 'single',
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Portfolio Recent Posts',
						'desc' => __( 'Most recent posts from your portfolio', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[portfolio_recent_posts title="Portfolio recent posts" limit="5" cats="" wordscount="20"]',
				'desc' => __( 'Portfolio Recent Posts', 'shortcodes-ultimate' )
			),
			# Portfolio Popular Posts
			'portfolio_popular_posts' => array(
				'name' => 'Portfolio Popular Posts',
				'type' => 'single',
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Portfolio Popular Posts',
						'desc' => __( 'Popular posts from your portfolio', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[portfolio_popular_posts title="Portfolio popular posts" limit="5" cats="" wordscount="20"]',
				'desc' => __( 'Portfolio Popular Posts', 'shortcodes-ultimate' )
			),
			# Portfolio Posts
			'portfolio_posts' => array(
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Posts from your portfolio', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
					...
					'order' => array(
						...
						'default' => 'DESC',
						'desc' => __( 'Designate the ascending or descending order of posts', 'shortcodes-ultimate' )
					),
					'cats' => array(
						'values' => false,
						'default' => '',
					...
					'columns' => array(
						...
						'default' => '4',
						'desc' => __( 'Choose the number of columns to show. For sidebar page choose 3, for full width page choose 4.', 'shortcodes-ultimate' )
					),
					'carousel_mode' => array(
						'values' => array(
							'yes',
						...
						'default' => 'yes',
						'desc' => __( 'Select carousel mode', 'shortcodes-ultimate' )
					),
					'slideshow' => array(
						'values' => array(
							'true',
						...
						'default' => 'false',
						'desc' => __( 'Autoplay carousel?', 'shortcodes-ultimate' )
					)
				),
				'usage' => '[portfolio_posts title="Portfolio posts" orderby="date" order="desc" limit="5" cats="" carousel_mode="yes" slideshow="false"]',
				'desc' => __( 'Portfolio Posts', 'shortcodes-ultimate' )
			),
			# Sponsors Posts
			'sponsors_posts' => array(
				...
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Sponsors Posts',
						'desc' => __( 'Posts from your sponsors', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
					...
					'columns' => array(
						...
						'default' => '4',
						'desc' => __( 'Choose the number of columns to show. For sidebar page choose 3, else 4.', 'shortcodes-ultimate' )
					),
					'orderby' => array(
						'values' => array(
							'none',
				...
				'usage' => '[sponsors_posts title="Sponsors posts" orderby="date" order="desc" limit="5" carousel_mode="yes" columns="4" slideshow="false"]',
				'desc' => __( 'Sponsors Posts', 'shortcodes-ultimate' )
			),
			# Testimonials Posts
			'testimonials_posts' => array(
				...
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Testimonials Posts',
						'desc' => __( 'Posts from your testimonials', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[testimonials_posts title="Testimonials posts" orderby="date" order="desc" limit="5" carousel_mode="yes" slideshow="false" columns="4"]',
				'desc' => __( 'Testimonials Posts', 'shortcodes-ultimate' )
			),
			# Team Posts
			'team_posts' => array(
				'name' => 'Team Posts',
				...
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Team Posts',
						'desc' => __( 'Posts from your team', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[team_posts title="Team posts" orderby="date" order="desc" limit="5" carousel_mode="yes" slideshow="false" columns="4"]',
				'desc' => __( 'Team Posts', 'shortcodes-ultimate' )
			),
			# Ads Posts
			'ads_posts' => array(
				'name' => 'Ads Posts',
				...
				'atts' => array(
					'title' => array(
						'values' => false,
						'default' => 'Ads Posts',
						'desc' => __( 'Posts from your ads', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[ads_posts title="Ads posts" orderby="date" order="desc" limit="5" carousel_mode="yes" slideshow="false" columns="4"]',
				'desc' => __( 'Ads Posts', 'shortcodes-ultimate' )
			),
			...
			'best_selling_products' => array(
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Best selling products', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[best_selling_products title="Best selling products" per_page="12" columns="4" orderby="date" order="desc" carousel_mode="yes" slideshow="false"]',
				'desc' => __( 'Portfolio Posts', 'shortcodes-ultimate' )
			),
			# Sale products
			'sale_products' => array(
				...
				'atts' => array(
					'title' => array(
						...
						'desc' => __( 'Sale products', 'shortcodes-ultimate' )
					),
					'limit' => array(
						'values' => false,
						'default' => '5',
				...
				'usage' => '[sale_products per_page="12" columns="4" orderby="date" order="desc" carousel_mode="yes" slideshow="false"]',
				'desc' => __( 'Sale products posts', 'shortcodes-ultimate' )
			),
